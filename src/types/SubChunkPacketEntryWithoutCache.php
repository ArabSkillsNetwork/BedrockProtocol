...
final class SubChunkPacketEntryWithoutCache{
	...
	public static function read(ByteBufferReader $in) : self{
		...
		CommonTypes::readOptional($in, LE::readUnsignedLong(...)); //blob hash, never present without the cache
	...
	public function write(ByteBufferWriter $out) : void{
		$this->base->write($out);
		CommonTypes::putBool($out, false); //blob hash, never present without the cache
	}
}
